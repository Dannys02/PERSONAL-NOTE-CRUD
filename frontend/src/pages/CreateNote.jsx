...
export default function CreateNote() {
    ...
    return (
        <div className="transition-colors duration-300">
            ...
            <form onSubmit={handleSubmit}> {/* Gunakan onSubmit di sini */}
                    ...
                    <div className="flex items-center gap-3 px-4 py-3 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm focus-within:border-indigo-500  dark:focus-within:ring-indigo-900/20 transition-all duration-300 cursor-pointer group">
                        ...
                        <div className="flex-1">
                            ...
                            >
                                ...
                                <option value="Harian" className="text-slate-700 dark:bg-slate-900 dark:text-slate-200">Harian</option>
                                <option value="Edukasi" className="text-slate-700 dark:bg-slate-900 dark:text-slate-200">Edukasi</option>
                                <option value="Hobi" className="text-slate-700 dark:bg-slate-900 dark:text-slate-200">Hobi</option>
                                <option value="Kerja" className="text-slate-700 dark:bg-slate-900 dark:text-slate-200">Kerja</option>
                                <option value="Lainnya" className="text-slate-700 dark:bg-slate-900 dark:text-slate-200">Lainnya</option>
                            </select>
                        </div>
